...
public class Menu {
	public static void menu() {
		...
		System.out.println("\n\t*BOOK OPERATIONS*" + "\n\n1.Add Contact\t\t2.Edit Contact"
				...
				+ "\n9.View By State\t\t10.View By City\n11.Count By State\t\t12.Count By City\n13.Sort By Name\t\t14.Sort By State\n15.Sort By City\t\t16.Sort By ZipCode\n17.Read From File\t\t18.Write Into File"
				+ "\n19.Exit");
		System.out.println("\nEnter An Operation :");
		...
		case 1: {
			...
			ContactOperations.addContact(ContactOperations.bookName);
			menu();
		}
		case 2: {
		...
		case 14: {
			// Sort By State
			ContactOperations.sortByState();
		}
		case 15: {
			// Sort By City
			ContactOperations.sortByCity();
		}
		case 16: {
			// Sort By ZipCode
			ContactOperations.sortByZipCode();
		}
		case 17: {
			// Fetch Data From File
			ContactOperations.getDataFromFile();
		}
		case 18: {
